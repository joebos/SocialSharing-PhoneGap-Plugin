...
public class SocialSharing extends CordovaPlugin {
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    ...
    if (ACTION_AVAILABLE_EVENT.equals(action)) {
      ...
      return doSendIntent(callbackContext, args.getString(0), args.getString(1), args.getJSONArray(2), args.getString(3), "com.google.android.apps.plus/com.google.android.apps.plus.phone.UrlGatewayActivity", false);
