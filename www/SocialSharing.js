...
SocialSharing.prototype.shareViaGooglePlus = function (message, fileOrFileArray, url, successCallback, errorCallback) {
  cordova.exec(successCallback, this._getErrorCallback(errorCallback, "shareViaFacebook"), "SocialSharing", "shareViaGooglePlus", [message, null, this._asArray(fileOrFileArray), url]);
};
